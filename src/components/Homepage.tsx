  ...
  return (
    <div className='flex items-center justify-around pt-32 text-center text-white'>
        ...
        <div className='mb-16 max-sm:text-center '>
            ...
            <p className='pt-8 text-xl font-thin'> Earn $TON money on Telegram <br></br>by selling your reels as PPV shows. Join <a href="https://t.me/ontonftv" target="_blank" style={{fontWeight: "bold", textDecoration: "underline"}}>@ppvton</a> Telegram for PPV trailers.</p>
            <br></br>
