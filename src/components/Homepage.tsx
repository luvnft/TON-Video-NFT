  ...
  return (
    <div className='flex items-center justify-around pt-32 text-center text-white'>
        ...
        <div className='mb-16 max-sm:text-center '>
            ...
            <p className='pt-8 text-xl font-thin'> Earn 💯 in Telegram $TON currency 24/7/365 <br></br>by selling short (Vids less than 30 secs) as PPV. <br></br>Join <a href="https://t.me/ppvcash" target="_blank" style={{fontWeight: "bold", textDecoration: "underline"}}>@ppvcash</a> Telegram to promote your PPV.</p><br></br>Follow <a href="https://x.com/ppvgem" target="_blank" style={{fontWeight: "bold", textDecoration: "underline"}}>@ppvgem</a> on X.
            <br></br>
