  ...
  return (
    <div className='flex items-center justify-around pt-32 text-center text-white'>
        ...
        <div className='mb-16 max-sm:text-center '>
            <h1 className='text-6xl font-semibold'>PPV is the Telegram OF<br></br><span className='font-thin text-sky-400'>with no middleman fee. </span></h1>
            <p className='pt-8 text-xl font-thin'> Earn 💯 in Telegram $TON currency 24/7/365 <br></br>by selling short (Vids less than 60 secs) as PPV. <br></br>Join <a href="https://t.me/ppvgem" target="_blank" style={{fontWeight: "bold", textDecoration: "underline"}}>@ppvgem</a> Telegram to promote your PPV.</p>
            <br></br>
